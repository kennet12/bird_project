							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" name="name" value="<?=!empty($partners->name)? $partners->name :''?>" class="form-control">
									</div>
									<div class="input-group">
										<span class="input-group-text" id="basic-addon1">Url</span>
										<input type="text" name="url" value="<?=!empty($parnerts->url)? $partners->url :''?>" class="form-control">
									</div>
									<div class="row">
										<div class="col-6">
											<label class="wrap-upload-banner" <?=!empty($partners->banner) ? 'style="background: url('. $partners->banner.')"' : ''?>') no-repeat">
