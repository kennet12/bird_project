    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6><?=$title?></h6>
                <a href="<?=site_url('syslog/partners/add')?>"><span class="badge badge-sm bg-gradient-success"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="<?=BASE_URL.$partner->banner?>" class="avatar avatar-sm me-3"
                                                alt="user1">
                                        </div>
                                ...
                                <td class="align-middle text-center">
                                    <ul class="action">
                                        <li><a href="<?=site_url("syslog/partners/edit/{$partner->id}")?>"><span
                                                    class="badge badge-sm bg-gradient-info">Sửa</span></a></li>
                                        <li><a class="btn-delete"
                                                linkHref="<?=site_url("syslog/partners/delete/{$partner->id}")?>"><span
                                                    class="badge badge-sm bg-gradient-danger">Xóa</span></a></li>
                                    </ul>
                                    <i class="updated-date"><?=$this->util->to_vn_date($partner->updated_date)?></i>
                                    <strong class="updated-by"><?=$partner->updated_by->fullname?></strong>
                                </td>
                            </tr>
                            <?$i++ ;}?>
                        </tbody>
