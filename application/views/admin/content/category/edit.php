							...
							<div class="col-md-10">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" id="title" name="title" value="<?=!empty($content_category->name)? $content_category->name :''?>" class="form-control">
									</div>
									<div class="input-group">
										<span class="input-group-text" id="basic-addon1">Alias</span>
										<input type="text" id="alias" name="alias" value="<?=!empty($content_category->alias)? $content_category->alias :''?>" class="form-control">
									</div>
									
									<div class="input-group">
									<div class="radio">
												<label>
													<input type="radio" name="active" id="input" value="1" checked="checked" <?=!empty($content_category->active) ? 'checked="checked"' : ''?>>
													Hiện
												</label>
											</div>
											<div class="radio">
												<label>
													<input type="radio" name="active" id="input" value="0" <?=empty($content_category->active) ? 'checked="checked"' : ''?>>
													Ẩn
												</label>
											</div>
										</div>
